...
sub display_search()
{
	...
	$text  .= under_line_stat(h3_stat("Search according to code ID"));
	...
	$text .= under_line_stat(h3_stat("Search according to categories"));	
	...
	$text  .= "check here to get results which contain" . under_line_stat(" ONLY ") . "the selected categories (and dont contain any other category)";
