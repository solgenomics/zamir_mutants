...
$FILENAME  = "mutant04_search_tmp.cgi";
...
sub display_search()
{
	...
	$top .= "<table border=1><TR>";
	
	$top .= "<TD rowspan=\"8\"><script type=\"text/javascript\" src=\"http://zamir.sgn.cornell.edu/mutants/2004/menu.js\"></script></TD>";
...
sub results()
{
	...
	$text .= "<TD rowspan=\"8\"><script type=\"text/javascript\" src=\"http://zamir.sgn.cornell.edu/mutants/2004/menu.js\"></script></TD>";
	$text .= "<TD>" . center_stat(under_line_stat(bold_stat(h1_stat("Search Results"))));
