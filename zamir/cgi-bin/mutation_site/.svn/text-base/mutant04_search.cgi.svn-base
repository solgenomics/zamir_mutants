...
my $FILENAME  = "mutant04_search.cgi";

my $DIR       = "/cgi-bin/mutation_site/";
my $PIC_DIR   = "/soldb/website/zamir/html/mutation_images/";
my $MAIN_URL  = "/cgi-bin/mutation_site/$FILENAME";
my $DAVIS_DIR = "http://tgrc.ucdavis.edu/data/acc/GenDetail.CFM?GENES.gene=";
