...
$FILENAME  = "mutant04_test.cgi";

$DIR       = "/cgi-bin/mutation_site/";
$PIC_DIR   = "/soldb/website/zamir/html/mutation_images/";
...
sub display_search()
{
	...
	$top .= "<TD rowspan=\"8\" width=200><script type=\"text/javascript\" src=\"http://zamir.sgn.cornell.edu/mutants/2004/menu.js\"></script></TD>";
	...
	@tgrc = get_tgrc_genes();
	@sorted_tgrc= sort { lc $a cmp lc $b } @tgrc;
...
sub get_tgrc_genes()
{
	...
	my $query;
   		...
   		$query = "SELECT similar_to_tgrc FROM mutant04 where similar_to_tgrc not like \"\"";
...
sub results()
{
	...
	$text .= "<TD rowspan=\"8\" valign=top width=200><script type=\"text/javascript\" src=\"http://zamir.sgn.cornell.edu/mutants/2004/menu.js\"></script></TD><TD>";
